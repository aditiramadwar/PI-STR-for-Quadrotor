...
grid on;
title('Input Voltages: PID','Interpreter', 'LaTex','Fontname', 'Times', 'FontSize', FontSize);
ylabel('V','Fontname', 'Times', 'FontSize', FontSize);
...
grid on;
legend1 = legend({'$U_{\max}$','$U_1$','$U_2$','$U_3$','$U_4$'},'Interpreter', 'LaTex', 'Fontname', 'Times', 'FontSize', 12);
set(legend1,'Position',[0.147738093960853 0.2954818280653 0.152500001464571 0.319047626313709],'FontSize',12);
title('Input Voltages: PI-STR','Interpreter', 'LaTex','Fontname', 'Times','FontSize', FontSize);
