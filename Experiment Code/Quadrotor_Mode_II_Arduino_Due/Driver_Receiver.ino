...
void updatepulse1() {
  ...
  if (digitalRead(channel1Pin)) rising1 = micros();
    ...
    pulse1 = constrain((uint32_t)(micros() - rising1), Pulse_MIN_Original, Pulse_MAX_Original);
...
void updatepulse2() {
  ...
  if (digitalRead(channel2Pin)) rising2 = micros();
    ...
    pulse2 = constrain((uint32_t)(micros() - rising2), Pulse_MIN_Original, Pulse_MAX_Original);
...
void updatepulse3() {
  ...
  if (digitalRead(channel3Pin)) rising3 = micros();
    ...
    pulse3 = constrain((uint32_t)(micros() - rising3), Pulse_MIN_Original, Pulse_MAX_Original);
...
void updatepulse4() {
  ...
  if (digitalRead(channel4Pin)) rising4 = micros();
    ...
    pulse4 = constrain((uint32_t)(micros() - rising4), Pulse_MIN_Original, Pulse_MAX_Original);
